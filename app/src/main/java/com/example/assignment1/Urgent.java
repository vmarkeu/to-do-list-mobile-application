...
public class Urgent extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int i, long l) {
                if (parent.getItemAtPosition(i).equals("Urgent")) {
                    // do nothing
                } else {
                    ...
                    if (parent.getItemAtPosition(i).equals("KIV")) {
                        Intent intent = new Intent(Urgent.this, KIV.class);
                        startActivity(intent);
                    } else if (parent.getItemAtPosition(i).equals("General")) {
                        Intent intent = new Intent(Urgent.this, General.class);
                        startActivity(intent);
                    } else {
                        Intent intent = new Intent(Urgent.this, Important.class);
                        startActivity(intent);
                    }
                }
            }
        ...
        add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Urgent.this, AddActivity.class);
                startActivity(intent);
            }
        });
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Urgent.this, MainActivity.class);
                startActivity(intent);
            }
        });

        myDB = new MyDatabaseHelper(Urgent.this);
        ...
        customAdapter = new CustomAdapter(Urgent.this, this, task_id, task_title, task_desc, task_cat, task_status, this::remoteUpdate);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(Urgent.this));
    ...
    void storeDataInArrays() {
        Cursor cursor = myDB.readUrgentData();
    ...
    Urgent showPopupMenu() {
        ImageView task_status_options = findViewById(R.id.task_status_options);

        PopupMenu popup = new PopupMenu(Urgent.this, task_status_options);
        popup.getMenuInflater().inflate(R.menu.status_menu, popup.getMenu());

        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            public boolean onMenuItemClick(MenuItem item) {
                Toast.makeText(Urgent.this, "You Clicked : " + item.getTitle(), Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        return null;
